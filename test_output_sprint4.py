...
(listOfPeople3,listOfFamilies3)= main.gedComParse('correct3.ged')
(listOfPeople4,listOfFamilies4)= main.gedComParse('error4.ged')
userStory27.us_27(listOfPeople4)
main.present(listOfPeople4,listOfFamilies4)
