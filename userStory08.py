                    ...
                    if child != False:
                        if child.Birthday != "NA":
                            ...
                            if MarriedNum > BirthdayNum:
                                print(
                                    "ERROR: FAMILY: US08: In family " + family.ID + ", birthday of child " + id + " is before parents' marriage")
                                flag = False
                    ...
                    if child != False:
                        if child.Birthday != "NA":
                            ...
                            if BirthdayNum > DivorcedNum:
                                print(
                                    "ERROR: FAMILY: US08: In family " + family.ID + ", birthday of child " + id + " is more than 9 months after parents' divorce")
                                flag = False
